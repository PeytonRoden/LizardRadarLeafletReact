...
struct SingleTilt {
    ...
    std::vector<float> VelNyquist;     // Nyquist velocity in m/s, one entry per VEL radial that has >=1 valid gate
    std::vector<VelocityRay> VelocityRays;
};
